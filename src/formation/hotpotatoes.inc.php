...
function hotpot_patch_file( $nomFichier, $IdHotpot, $IdActiv ,$IdSousActiv, $IdSessionExercice, $iNumeroPage) {
	...
	/**
	 * 
	 * On verifie que l'exercice n'a pas d�j� �t� fait par l'�tudiant sur cette "session d'exercice"
	 * Si d�j� fait, on n'enregistre pas le score, mais on affiche celui enregist� auparavant
	 * 
	 */
	...
	if ($iScoreExercice == NULL) { // exercice pas encore fait, on active Ajax pour l'ins�rer dans la DB
...
// on ajoute un bool�en pour �viter d'ins�rer plusieurs fois la m�me entr�e.
// La fonction Finish() est appel�e toutes les 30 secondes m�me quand l'exercice est termin�.
...
/*
 * l'exercice est d�j� fait, on affiche le score et la moyenne
 */
	else {
...
WriteToInstructions(YourScoreIs + ' ' + $iScoreExercice + '%.<br />Moyenne : ' + $iMoyenne +'%.');
 	...
 	* On prend le numero de page actuelle et on enl�ve 1.
 	*/
