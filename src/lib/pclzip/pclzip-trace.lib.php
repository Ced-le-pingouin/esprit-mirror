...
//
// --------------------------------------------------------------------------------
// $Id: pclzip-trace.lib.php,v 1.55 2006/03/08 21:23:59 vblavet Exp $
// --------------------------------------------------------------------------------
  ...
  function privFileDescrExpand(&$p_filedescr_list, &$p_options)
  {
    ...
    for ($i=0; $i<sizeof($p_filedescr_list); $i++) {
      ...
      if (!file_exists($v_descr['filename'])) {
        // ----- Error log
        PclTraceFctMessage(__FILE__, __LINE__, 2, "File '".$v_descr['filename']."' does not exists");
  ...
  function privAddFileList($p_filedescr_list, &$p_result_list, &$p_options)
  {
    ...
    for ($j=0; ($j<sizeof($p_filedescr_list)) && ($v_result==1); $j++) {
      ...
      if (!file_exists($p_filedescr_list[$j]['filename'])) {
        PclTraceFctMessage(__FILE__, __LINE__, 2, "File '".$p_filedescr_list[$j]['filename']."' does not exists");
    ...
    if ($p_header['status'] == 'ok') {
      ...
      if (is_file($p_filename))
      {
        ...
        if ((isset($p_options[PCLZIP_OPT_CRYPT]))
          ...
          PclTraceFctMessage(__FILE__, __LINE__, 2, "File need to be crypted ....");
          ...
          PclTraceFctMessage(__FILE__, __LINE__, 2, "Size after header : ".strlen($v_content_compressed)."");
        }
        */
        ...
        if ($p_entry['compression'] == 0) {
          ...
          if (($p_entry['flag'] & 1) == 1) {
            ...
            /*
              ...
              PclTraceFctMessage(__FILE__, __LINE__, 5, "Read 12 encryption header bytes");
              $v_encryption_header = @fread($this->zip_fd, 12);
              
              // ----- Read the encrypted & compressed file in a buffer
              PclTraceFctMessage(__FILE__, __LINE__, 5, "Read '".($p_entry['compressed_size']-12)."' compressed & encrypted bytes");
              ...
              PclTraceFctMessage(__FILE__, __LINE__, 5, "Buffer is '".$v_buffer."'");
              */
          }
          else {
