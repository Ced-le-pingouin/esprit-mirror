...
class CModule
{
	...
	function retNom ($v_bHtmlEntities=FALSE) { return ($v_bHtmlEntities ? mb_convert_encoding($this->oEnregBdd->NomMod,"HTML-ENTITIES","UTF-8") : $this->oEnregBdd->NomMod); }
	...
	function retNomComplet ($v_bHtmlEntities=FALSE)
	{
		...
		return ($v_bHtmlEntities ? mb_convert_encoding($sNomComplet,"HTML-ENTITIES","UTF-8") : $sNomComplet);
	}
	...
	function retDescr ($v_bHtmlEntities=FALSE) { return ($v_bHtmlEntities ? mb_convert_encoding($this->oEnregBdd->DescrMod,"HTML-ENTITIES","UTF-8") : $this->oEnregBdd->DescrMod); }
