...
<frameset cols="228,*" border="0" frameborder="0" framespacing="0">
<frame src="{login->url}" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" noresize="noresize">
<frameset rows="138,*" border="0" frameborder="0" framespacing="0">
<frame src="theme://login/login-haut.htm" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" noresize="noresize">
<frame src="theme://login/login-infos.htm" frameborder="0" scrolling="auto">
</frameset>
</frameset>
<frame src="theme://login/login-bas0.htm" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" noresize="noresize">
<frame src="theme://login/login-bas1.htm" frameborder="0" marginwidth="0" marginheight="5" scrolling="no" noresize="noresize">
</frameset>
</html>
