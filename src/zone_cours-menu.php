	...
	else
	{
		foreach ($oActiv->aoSousActivs as $oSousActiv)
		{
			...
			if (isset($sHref))
			{
				...
				$oBlockSousActiv->remplacer("{sousactiv.nom}",htmlentities($sNomSousActiv,ENT_COMPAT,"UTF-8"));
				$oBlockSousActiv->remplacer("{sousactiv.nom_encoder}",htmlentities($sNomSousActiv,ENT_COMPAT,"UTF-8"));
