	...
	switch ($err)
	{
		case UPLOAD_EXTENSION_INTERDITE:
			...
			echo "<html>\n"
				...
				."<body onload=\"init()\">\n"
				."<br><br>\n"
				."<div align=\"center\"><h4>".mb_convert_encoding("Ce fichier n'est pas autorisé à la copie.","HTML-ENTITIES","UTF-8")."</h4></div>\n"
		...
		case UPLOAD_ERREUR:
			...
			echo "<html>\n"
				...
				."<body onload=\"init()\">\n"
				."<br><br>\n"
				."<div align=\"center\"><h4>".mb_convert_encoding("Le transfert du fichier a échoué.","HTML-ENTITIES","UTF-8")."</h4></div>\n"
				."<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\n"
				."</table>\n"
				."</body>\n"
				."</html>\n";
		...
		default:
			...
			if ($bOk)
				...
				echo "<html>\n"
					...
					."<br><br>\n"
					."<div align=\"center\">"
					."<h4>".mb_convert_encoding("Le document \"{$sNomRes}\" n'a pas pu être déposé.","HTML-ENTITIES","UTF-8")."</h4>"
					."</div>\n"
					."</body>\n"
					."</html>\n";
