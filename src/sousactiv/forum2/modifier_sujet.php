...
else if ($url_sModaliteFenetre == "modifier")
{
	...
	// Titre
	$oBlockSujet->remplacer("{titre->valeur}",htmlentities($oSujetForum->retTitre(),ENT_COMPAT,"UTF-8"));
...
else if ($url_sModaliteFenetre == "supprimer")
{
	...
	//$oBlockSujet->remplacer("{sujet->titre}",htmlentities($oSujetForum->retTitre(),ENT_COMPAT,"UTF-8"));
