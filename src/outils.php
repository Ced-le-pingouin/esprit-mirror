...
$aaOutils = array(
	...
	, array(TXT_EXPORTER_INSCRITS_TITRE,"export_liste_personnes.gif","exporter_liste_personnes()",TXT_EXPORT_DESCRIPTION,$oProjet->verifPermission("PERM_OUTIL_EXPORT_TABLE_PERSONNE"))
	, array(TXT_ENVOI_COURRIEL_TITRE,"courriel_envoye.gif","choix_courriel('?idPers=tous&idForm={$iIdForm}&typeCourriel=courriel-formation@formation')",TXT_ENVOI_COURRIEL_DESCRIPTION,$oProjet->verifPermission("PERM_OUTIL_ENVOI_COURRIEL"))
