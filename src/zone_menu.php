...
if ($iIdMod > 0)
{
	...
	$oTpl->remplacer("{cours.titre}",htmlentities($oProjet->oModuleCourant->retNom(),ENT_COMPAT,"UTF-8"));
	// }}}
	...
	for ($r=0; $r<$iNbrRubriques; $r++)
	{
		...
		// Nom de l'unité
		$sNomUnite = htmlentities($aoRubriques[$r]->retNom(),ENT_COMPAT,"UTF-8");
...
$oTpl->remplacer("{outils.choix_courriel}",retLienEnvoiCourriel("?idStatuts=".STATUT_PERS_TUTEUR."x".STATUT_PERS_ETUDIANT."x".STATUT_PERS_RESPONSABLE."&typeCourriel=courriel-module"));
