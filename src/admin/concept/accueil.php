<?php
if (isset($modifier) || isset($rafraichir))
	exit();
?>
<table border="0" cellspacing="10" cellpadding="0" width="100%" height="100%">
<tr>
<td width="50%" style="text-align: right;"><h1 style="font-size: 13pt;">Conception d'un cours</h1></td>
<td style="background-color: rgb(120,120,100);" width="1px">.</td>
<td>
