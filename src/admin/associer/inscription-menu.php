...
$aMenus[] = array(_("Rafra&icirc;chir"),"top.frames['Principal'].frames['FRM_PERSONNE'].location.reload(true);top.frames['Principal'].frames['FRM_INSCRIT'].location.reload(true);",3,"text-align: right");
