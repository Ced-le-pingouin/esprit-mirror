...
foreach ($g_aoDossierForms as $oDossierForms)
{
	...
	$oBlocDossierForms->remplacer("{dossier_formations.titre}",htmlentities($oDossierForms->retNom()));
}
...
$oTpl->remplacer("{dossier_formation.nom}",htmlentities($sNomDossierForms));
