...
$oBloc_onglet_champs->remplacer("{onglet->titre}",str_replace(" ","&nbsp;",htmlentities("Liste des champs",ENT_COMPAT,"UTF-8")));
...
$oBloc_onglet_type_fichiers->remplacer("{onglet->titre}",str_replace(" ","&nbsp;",htmlentities("Types de fichier",ENT_COMPAT,"UTF-8")));
