...
$oBloc_onglet_champs->remplacer("{onglet->titre}",str_replace(" ","&nbsp;",emb_htmlentities("Liste des champs")));
...
$oBloc_onglet_type_fichiers->remplacer("{onglet->titre}",str_replace(" ","&nbsp;",emb_htmlentities("Types de fichier")));
