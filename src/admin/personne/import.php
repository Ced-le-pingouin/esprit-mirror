...
// print_r($data->sheets);
	for ($nrow=6; $nrow<$data->sheets[0]['numRows']; $nrow++) {
		...
		if (preg_match('/importOKPetit/', $res))
		{
			...
			else $sMotDePasse = " (votre mot de passe n'a pas ÈtÈ changÈ)";
		}
		else
		{
		...
		$sMessageCourrielTexte = "Bonjour,\r\n\r\nCe mail vous informe que vous avez bien ÈtÈ inscrit(e)";
		if ($sNomFormation!="") $sMessageCourrielTexte .= " ‡ la formation\r\n '$sNomFormation'\r\naccessible";
