<?php
$sTitrePrincipal = htmlentities("Exporter une liste de la table des personnes");
...
<frame name="titre" src="exporter-titre.php<?=$sParamsURL?>" marginwidth="0" marginheight="0" frameborder="0" scrolling="no" noresize="noresize">
