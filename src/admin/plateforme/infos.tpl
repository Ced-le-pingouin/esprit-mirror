...
<p>
[BLOCK_ADMINISTRATEUR+]<span class="administrateur">{personne.nom} {personne.prenom} <span class="administrateur_courriel">&laquo;&nbsp;<a href="mailto:{personne.courriel}" onfocus="blur()">{personne.courriel}</a>&nbsp;&raquo;</span></span><br>[BLOCK_ADMINISTRATEUR-]
</div>
<div id="session_serveur_chat">N&deg; port du serveur chat&nbsp;:<br><span id="chat_port">{chat.port}</span></div>
<div id="session_serveur_awareness">N&deg; port du serveur awareness&nbsp;:<br><span id="awareness_port">{awareness.port}</span></div>
</div>
</body>
</html>
