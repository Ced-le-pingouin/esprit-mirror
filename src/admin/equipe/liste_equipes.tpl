...
[SET_COURRIEL+]<a href="mailto:{personne.courriel}" title="Envoyer un courriel" onfocus="blur()"><img src="commun://icones/mail.gif" width="16" height="16" border="0"></a>[SET_COURRIEL-]
