...
require_once(dir_database("qtextecourt.tbl.php")); //AJOUTE PAR LUDO
require_once(dir_database("qtextelong.tbl.php")); //AJOUTE PAR LUDO
...
require_once(dir_database("formulairecomplete.tbl.php")); //AJOUTE PAR LUDO
?>
